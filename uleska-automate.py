...
def _main():
    ...
    arg_options.add_argument('--compare_latest_results', help="Retrieve the latest test results for version and compare", action="store_true")
...
def run_create_version_with_credentials(host, application, version_name, token, print_json, sast_git, sast_username, sast_token, tools_to_add):
